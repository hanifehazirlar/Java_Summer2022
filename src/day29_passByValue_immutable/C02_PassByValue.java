...
public class C02_PassByValue {
    public static void main(String[] args) {
         ...
         */
        int[] arr={3,5,8,10};
        System.out.println("1."+arr); // 1.[I@5f2050f6
        ...
        System.out.println("2."+arr); // 2.[I@5f2050f6
    }
    public static void arrayiDegistir(int[] arr) {
        ...
        System.out.println("method'da array : " + Arrays.toString(arr)); // method'da array : [13, 61, 56]
        System.out.println("3."+arr); // 3.[I@13fee20c
